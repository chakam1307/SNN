...
data_arg.add_argument('--valid_trials', type=int, default=32,
                      help='# of validation 1-shot trials')
data_arg.add_argument('--test_trials', type=int, default=40,
                      help='# of test 1-shot trials')
data_arg.add_argument('--way', type=int, default=10,
                      help='Ways in the 1-shot trials')
data_arg.add_argument('--num_train', type=int, default=9000,
...
misc_arg.add_argument('--num_model', type=int, default=4, required=False,
